    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const fetchedProducts =await result.data.data;
    ...
    return (
        <div className="flex flex-col w-full h-full items-center bg-black">
            <div className="flex w-full flex-row items-start">
                <h2 className="flex-1 text-white text-2xl mb-5 text-center">{type}</h2>
                            ...
                            >
                                ...
                                >
                                    <img
                                        ...
                                        src={moreOptions}
                                        alt="More Options"
                                        className={`cursor-pointer w-8 transition-transform duration-300 ${hoveredProductId === productData._id ? "rotate-180" : ""
                                            }`}
                                    />
