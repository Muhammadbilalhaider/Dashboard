...
const Navbar = () => {
  ...
  return (
    <>
      {/* Toggle Icon - visible only on small screens */}
      <div className="flex justify-between items-center p-4 bg-red-600 md:hidden w-full fixed top-0 left-0 z-10">
        <img
          src={sideimg}
          alt="Toggle Sidebar"
      ...
      {/* Add this style to the body */}
      <style>
        {`
          body, html {
            margin: 0;
            padding: 0;
            background-color: transparent; /* Or red to match your navbar */
          }
        `}
      </style>
    </>
